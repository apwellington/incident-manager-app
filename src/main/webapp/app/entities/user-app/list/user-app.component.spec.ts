...
describe('UserApp Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'user-app', component: UserAppComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to userAppService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getUserAppIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getUserAppIdentifier).toHaveBeenCalledWith(entity);
