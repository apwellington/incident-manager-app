...
describe('Department e2e test', () => {
  ...
  const departmentSample = { name: 'duh sedately before' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="name"]`).type('yearningly officially knowledgeable');
      cy.get(`[data-cy="name"]`).should('have.value', 'yearningly officially knowledgeable');

      cy.get(`[data-cy="description"]`).type('deeply huzzah');
      cy.get(`[data-cy="description"]`).should('have.value', 'deeply huzzah');
