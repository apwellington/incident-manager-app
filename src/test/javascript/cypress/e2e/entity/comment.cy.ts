...
describe('Comment e2e test', () => {
  ...
  const commentSample = { content: 'browser', commentDate: '2023-12-21T17:36:23.457Z' };
  ...
  describe('new Comment page', () => {
    ...
    it('should create an instance of Comment', () => {
      cy.get(`[data-cy="content"]`).type('action finally');
      cy.get(`[data-cy="content"]`).should('have.value', 'action finally');

      cy.get(`[data-cy="commentDate"]`).type('2023-12-21T18:02');
      cy.get(`[data-cy="commentDate"]`).blur();
      cy.get(`[data-cy="commentDate"]`).should('have.value', '2023-12-21T18:02');
