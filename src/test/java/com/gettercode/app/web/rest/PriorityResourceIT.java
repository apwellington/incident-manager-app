...
class PriorityResourceIT {
    ...
    public static Priority createEntity(EntityManager em) {
        Priority priority = new Priority().name(DEFAULT_NAME).level(DEFAULT_LEVEL);
        return priority;
    }
    ...
    public static Priority createUpdatedEntity(EntityManager em) {
        Priority priority = new Priority().name(UPDATED_NAME).level(UPDATED_LEVEL);
        return priority;
    }
    ...
    void createPriority() throws Exception {
        ...
        assertThat(testPriority.getLevel()).isEqualTo(DEFAULT_LEVEL);
    }
    ...
    void putExistingPriority() throws Exception {
        ...
        updatedPriority.name(UPDATED_NAME).level(UPDATED_LEVEL);
        ...
        assertThat(testPriority.getLevel()).isEqualTo(UPDATED_LEVEL);
    }
    ...
    void partialUpdatePriorityWithPatch() throws Exception {
        ...
        partialUpdatedPriority.name(UPDATED_NAME).level(UPDATED_LEVEL);
