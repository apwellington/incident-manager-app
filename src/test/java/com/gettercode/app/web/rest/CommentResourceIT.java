...
import com.gettercode.app.repository.CommentRepository;
...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().content(DEFAULT_CONTENT).commentDate(DEFAULT_COMMENT_DATE);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().content(UPDATED_CONTENT).commentDate(UPDATED_COMMENT_DATE);
        return comment;
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.content(UPDATED_CONTENT).commentDate(UPDATED_COMMENT_DATE);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.content(UPDATED_CONTENT).commentDate(UPDATED_COMMENT_DATE);
