...
class StatusResourceIT {
    ...
    public static Status createEntity(EntityManager em) {
        Status status = new Status().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return status;
    }
    ...
    public static Status createUpdatedEntity(EntityManager em) {
        Status status = new Status().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return status;
    }
    ...
    void putExistingStatus() throws Exception {
        ...
        updatedStatus.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
